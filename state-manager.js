...
export const DEFAULT_MODULES = {
    ...
    quest: { enabled: true, tag: 'QUEST', format: 'Name | Location | Description | Keywords',         instruction: 'ONLY record a quest when the player explicitly accepts it (i.e. "[QUEST ACCEPTED]" is outputted in the narrative). A quest being mentioned or offered is NOT enough.' },
...
**FAC** uses four fields: \`Name | Status | Description | Keywords\`. Put a concise current-state line in **Status** (standing, conflicts, recent changes); put history, ideology, schemes, and members in **Description**.`,
    ...
    if (s.routerModules && typeof s.routerModules.npc === 'boolean') {
        ...
        s.routerModules = {
            ...
            quest: { enabled: !!old.quest, tag: 'QUEST', format: 'Name | Location | Description | Keywords', instruction: 'ONLY record a quest when the player explicitly accepts it (i.e. "[QUEST ACCEPTED]" is outputted in the narrative). A quest being mentioned or offered is NOT enough.' },
